...
def create_main_interface(root, main_frame, show_categories, show_products, show_customers, show_purchases, show_history):
    ...
    tk.Button(nav_frame, text="Purchases", command=show_purchases,
              **button_style).pack(side='left', padx=10, pady=10)
    tk.Button(nav_frame, text="Purchase History", command=show_history,
              **button_style).pack(side='left', padx=10, pady=10)
